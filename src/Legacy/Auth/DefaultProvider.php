...
namespace Hubleto\Legacy\Auth;

class DefaultProvider extends \Hubleto\Legacy\Core\Auth {
  public $loginAttribute = 'login';
  public $passwordAttribute = 'password';
  public $activeAttribute = 'is_active';
  public $verifyMethod = 'password_verify';

  function __construct(\Hubleto\Legacy\Core\Loader $app)
  {
    parent::__construct($app);

    $this->app->registerModel(\Hubleto\Legacy\Models\User::class);
    $this->app->registerModel(\Hubleto\Legacy\Models\UserRole::class);
    $this->app->registerModel(\Hubleto\Legacy\Models\UserHasRole::class);
  }
  ...
  public function createUserModel(): \Hubleto\Legacy\Core\Model
  {
