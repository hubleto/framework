...
class Boolean extends \Hubleto\Legacy\Core\Db\Column
{
  ...
  public function setYesValue(mixed $yesValue): \Hubleto\Legacy\Core\Db\Column\Boolean { $this->yesValue = $yesValue; return $this; }

  public function getNoValue(): mixed { return $this->noValue; }
  public function setNoValue(mixed $noValue): \Hubleto\Legacy\Core\Db\Column\Boolean { $this->noValue = $noValue; return $this; }
