...
class Lookup extends \Hubleto\Legacy\Core\Db\Column
{
  ...
  public function __construct(\Hubleto\Legacy\Core\Model $model, string $title, string $lookupModel = '', string $foreignKeyBehaviour = 'RESTRICT')
  {
