...
class Decimal extends \Hubleto\Legacy\Core\Db\Column
{
  ...
  public function __construct(\Hubleto\Legacy\Core\Model $model, string $title, int $byteSize = 14, int $decimals = 4)
  {
