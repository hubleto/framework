...
class Loader
{
  ...
  public function translate(string $string, array $vars = [], string $context = "Hubleto\Legacy\Core\Loader::root", $toLanguage = ""): string
  {
  ...
  public function renderExceptionHtml($exception, array $args = []): string
  {
    ...
    switch (get_class($exception)) {
      case 'Hubleto\Legacy\Core\Exceptions\DBException':
        $html = "
      ...
      case 'Hubleto\Legacy\Core\Exceptions\DBDuplicateEntryException':
