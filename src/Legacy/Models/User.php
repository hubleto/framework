...
class User extends \Hubleto\Legacy\Core\Model {
  ...
  public ?array $junctions = [
    'roles' => [
      'junctionModel' => \Hubleto\Legacy\Models\UserHasRole::class,
  ...
  public function __construct(\Hubleto\Legacy\Core\Loader $app)
  {
    ...
    $tokenModel = $app->getModel("Hubleto/Legacy/Models/Token");
  ...
  public function describeColumns(): array
  {
    return array_merge(parent::describeColumns(), [
      ...
      'password' => new \Hubleto\Legacy\Core\Db\Column\Password($this, 'Password'),
      'is_active' => new \Hubleto\Legacy\Core\Db\Column\Boolean($this, 'Active'),
      'last_login_time' => new \Hubleto\Legacy\Core\Db\Column\DateTime($this, 'Time of last login'),
      'last_login_ip' => new \Hubleto\Legacy\Core\Db\Column\Varchar($this, 'Last login IP'),
      'last_access_time' => new \Hubleto\Legacy\Core\Db\Column\DateTime($this, 'Time of last access'),
      'last_access_ip' => new \Hubleto\Legacy\Core\Db\Column\Varchar($this, 'Last access IP'),
    ]);
  }
  ...
  public function generateToken($idUser, $tokenSalt, $tokenType) {
    $tokenModel = $this->app->getModel("Hubleto/Legacy/Token");
